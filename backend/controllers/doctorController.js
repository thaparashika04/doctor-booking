...
const changeAvailability = async (req, res) => {
    try {
        // Safe logging inside the function
        ...
        console.log("Error in changeAvailability:", error.message);
...
const doctorList = async (req, res) => {
    try {
        ...
        console.log("Error in doctorList:", error.message);
        return res.status(500).json({
            success: false,
            message: error.message
        });
...
const appointmentsDoctor = async (req, res) => {
    try {
        const docId = req.docId.id; // get from middleware
...
//api to get docotor profile for doctor panel
